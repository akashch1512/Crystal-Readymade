...
const allowedOrigins = [
  'https://crystal-readymade-production.up.railway.app', // backend
  'https://crystalreadymades.com', // frontend (REMOVE trailing slash)
  'http://localhost:5137' // localhost (ADD protocol)
];
