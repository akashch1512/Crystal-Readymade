      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-bold text-blue-600">Crystal</span>
            <span className="text-2xl font-light text-purple-600">Readymade</span>
          </Link>
          ...
          <div className="hidden md:block relative flex-grow max-w-md mx-8">
            <form onSubmit={handleSearch} className="relative">
              <input
                ...
                className="w-full px-4 py-2 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                value={searchQuery}
